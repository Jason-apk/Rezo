import { useGtfsStore } from "../src/gtfs/store/gtfsStore";
...
const styles = StyleSheet.create({
    ...
    errorText: { color: "#F96167", fontSize: 14, textAlign: "center", marginBottom: 16 },
    ...
    sectionTitle: { fontSize: 16, fontWeight: "700", color: "#1E2761", marginBottom: 8 },
    list: { flex: 1 },
    listRow: {
        paddingVertical: 10,
        borderBottomWidth: 1,
